  ...
  render() {
    return (
      <div className="PdfFile">
        ...
        <br></br>
        <p className="font-weight-bold mt-1">Formulaire d'inscription pour l'exposition du 17/12/2023, Tarif : {REACT_APP_PRICE} </p>
        ...
        <Form>
          ...
          <FormGroup>
            ...
            <FormCheck inline label="Déclare avoir pris connaissance du règlement du salon d’Hiver 2023 de Carantec auquel je souhaite participer et en accepte les clauses"/>
          </FormGroup>
