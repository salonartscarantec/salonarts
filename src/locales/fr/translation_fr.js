export const TRANSLATIONS_FR = {
    ...
    linkregisterdownload:"Formulaire",
    ...
    //home page:
    expo:"Prochaine expo: le salon d'hiver",
    ...
    presentation4:"Pendant les expositions, les artistes peuvent proposer des",
    workshop:" ateliers",
    presentation5:" et nos bénévoles passionnés proposent des ",
    discovery:"parcours de découvertes",
    presentation6:"Si vous voulez plus d'informations, voir les affiches et les photos des expositions passées,",
    ...
    step2b:"Envoyer des photos de vos oeuvres par ",
    step2c:"Nouveaux inscrits: un texte sur votre parcours",
    ...
    retrivaldate:" vendredi 20 août de 10 à 12h",
    ...
    infospaintors:" : Chaque artiste dispose d’une surface de 1m20x1m80 (panneau horizontal ou vertical). Merci de respecter les dimensions car cette année le salon a lieu dans une salle de la mairie plus restreinte que notre salle habituelle.",
